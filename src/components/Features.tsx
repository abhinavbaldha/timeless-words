...
import { Edit, Globe, Search, Archive, CheckCircle } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: "A clean, distraction-free interface designed for writing, not tweaking settings.",
      delay: "delay-0"
    },
    {
      icon: <Globe className="h-7 w-7 text-copper" />,
      title: "Custom Domain Support",
      description: "Build your personal brand by publishing on your own domain.",
      delay: "delay-100"
    },
    {
      icon: <Search className="h-7 w-7 text-copper" />,
      title: "SEO & Long-Term Discoverability",
      description: "Your words won't just be read today—they'll be searchable and valuable for decades.",
      delay: "delay-200"
    },
    {
      icon: <Archive className="h-7 w-7 text-copper" />,
      title: "Content That Lives Forever",
      description: "No algorithms, no engagement farming—just pure, lasting writing.",
      delay: "delay-300"
    },
    {
    ...
    >
      <div className="text-center mb-16">
        ...
        <h2 
          ...
          ref={addToRefs}
        >
          A Writing Experience That <span className="text-copper">Feels Effortless</span>
        </h2>
        ...
        <p 
          ...
          ref={addToRefs}
        >
          Every aspect of Inscribe is designed to let you focus on what matters most: your words.
        </p>
      </div>
      ...
      <div className="mt-16 pt-12 grid md:grid-cols-2 gap-12">
        <div 
          ...
          ref={addToRefs}
        >
          <h3 className="text-2xl font-semibold mb-6">A platform that grows with you</h3>
          <p className="text-navy/70 mb-6">
            Whether you're writing occasional insights or building a comprehensive knowledge base, Inscribe scales to match your ambitions.
          </p>
