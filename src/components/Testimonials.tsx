...
const testimonials = [
  ...
  {
    quote: "Finally, a platform where my insights won't disappear in an algorithm.",
    author: "Michael Chen",
    title: "Founder, StrategyLabs",
    delay: "delay-100"
  },
  {
    quote: "The cleanest writing experience I've found. It's like writing on paper but better.",
    author: "David Torres",
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div 
          ...
          ref={addToRefs}
        >
          {['TechVision', 'StrategyLabs', 'FutureThink', 'InnovateNow'].map((company, index) => (
